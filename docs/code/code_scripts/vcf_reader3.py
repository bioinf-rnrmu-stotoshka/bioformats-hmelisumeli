...
class Vcf_reader:
    ...
    def stats(self, region_size=1000):
        ...
        - DataFrame с колонками: 
          CHROM: хромосома
          REGION: начальная позиция региона
          TOTAL_DEPTH: суммарная глубина покрытия в регионе
          VARIANT_COUNT: количество вариантов в регионе
        """
        result = {}
        def varlines():
            """
            ...
            ========================================
            Фильтрует и возвращает только строки с вариантами.
            """
            for x in self._lines():
                if not x.startswith('#'):
                    yield x
    ...
    def varregion(self, chrom, start, end):
        ...
        def gen():
            ...
            =============================================
            Фильтрует варианты по заданному региону.
            """
            for x in self._lines(): 
                if x.startswith('#'):
                    continue
