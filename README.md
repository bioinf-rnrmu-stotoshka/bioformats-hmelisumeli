 ...
 **Примечание:** для ссылки через GitHab Pages не удалось настроить отображение оформления из папки _static. При скачивании документации и просмотре через файлы html все отображается корректно.
